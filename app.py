...
def history_cathodics_recti():
    ...
    data_report.HICAPDOF = data_report.HICAPDOF.apply(lambda x: '0'  if len(x)>=5 else x)
    #data_report.HICAPDON = data_report.HICAPDON.apply(lambda x: '0'  if len(x)>=5 else x)
